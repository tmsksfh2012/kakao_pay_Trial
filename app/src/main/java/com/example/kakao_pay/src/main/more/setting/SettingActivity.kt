package com.example.kakao_pay.src.main.more.setting
...
import com.example.kakao_pay.src.main.more.setting.dialogs.DialogLogout
...
class SettingActivity : BaseActivity<ActivitySettingBinding>(ActivitySettingBinding::inflate) {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.textNameSetting.text = intent.getStringExtra("name")
